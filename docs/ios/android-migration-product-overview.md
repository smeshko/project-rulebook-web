...
|----------|-------------|
| [Design System JSON](./design-system-android.json) | Color, typography, spacing tokens in JSON format for direct import |
| [Screen Inventory](./android-migration-screens.md) | Detailed screen layouts, states, and visual specifications |
| [Navigation & Flows](./android-migration-navigation.md) | User journeys, gestures, and navigation patterns |
| [Component Library](./android-migration-components.md) | UI component specs with Compose implementation examples |
| [PRD & Features](./android-migration-prd.md) | Product requirements, user stories, and acceptance criteria |
